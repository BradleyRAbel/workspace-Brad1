...
cprequire_test(["inline:com-chilipeppr-workspace-Brad1"], function(ws) {
    ...
    $('title').html("Brad1 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-Brad1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-Brad1", // Make the id the same as the cpdefine id
        name: "Workspace / Brad1", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace Brad1.`,
